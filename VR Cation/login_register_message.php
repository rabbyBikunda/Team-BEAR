  ...
  <div class="container">
    ...
    <div class="row" style=" overflow: hidden;
      ...
      <div class="col-lg-12 mb-4">
        <div class="card h-60 text-center">
          <div class="card-body">
              <h4 class="card-title">Please <a href="login.php" style=" text-decoration: none;">login</a> or <a href="register.php" style=" text-decoration: none;">register</a> to create a tour</h4>
            <h6 ><div>
